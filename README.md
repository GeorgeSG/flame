...
[Docker Hub link](https://hub.docker.com/r/georgesg/flame)

```sh
docker pull georgesg/flame

# for ARM architecture (e.g. RaspberryPi)
docker pull georgesg/flame:multiarch

# installing specific version
docker pull georgesg/flame:2.0.0
```
...
```sh
# run container
docker run -p 5005:5005 -v /path/to/data:/app/data -e PASSWORD=flame_password georgesg/flame
```
...
```sh
# clone repository
git clone https://github.com/georgesg/flame
cd flame
